...
// Atribuições para CSNetworkableLoadout_t
// CSNetworkableLoadout_t Offsets
CSNetworkableLoadout_t.m_Item = findOffsetByName(j, "CSNetworkableLoadout_t", "m_Item");
CSNetworkableLoadout_t.m_unTeam = findOffsetByName(j, "CSNetworkableLoadout_t", "m_unTeam");
CSNetworkableLoadout_t.m_unSlot = findOffsetByName(j, "CSNetworkableLoadout_t", "m_unSlot");
...
CPlayer_MovementServices.m_vecLastFinishTickViewAngles = findOffsetByName(j, "CPlayer_MovementServices", "m_vecLastFinishTickViewAngles");
...
// Atribuições para CDestructiblePartsSystemComponent
// CDestructiblePartsSystemComponent Offsets
CDestructiblePartsSystemComponent.__m_pChainEntity = findOffsetByName(j, "CDestructiblePartsSystemComponent", "__m_pChainEntity");
CDestructiblePartsSystemComponent.m_DamageLevelTakenByHitGroup = findOffsetByName(j, "CDestructiblePartsSystemComponent", "m_DamageLevelTakenByHitGroup");
CDestructiblePartsSystemComponent.m_hOwner = findOffsetByName(j, "CDestructiblePartsSystemComponent", "m_hOwner");
CDestructiblePartsSystemComponent.m_nLastHitDamageLevel = findOffsetByName(j, "CDestructiblePartsSystemComponent", "m_nLastHitDamageLevel");
